...
public class Shaders
{
    ...
    public static void drawHorizon()
    {
        ...
        worldrenderer.pos(d2, d5, d3).func_181675_d();
        worldrenderer.pos(d2, d4, d3).func_181675_d();
        worldrenderer.pos(d3, d4, d2).func_181675_d();
        worldrenderer.pos(d3, d5, d2).func_181675_d();
        worldrenderer.pos(d3, d5, d2).func_181675_d();
        worldrenderer.pos(d3, d4, d2).func_181675_d();
        worldrenderer.pos(d3, d4, d1).func_181675_d();
        worldrenderer.pos(d3, d5, d1).func_181675_d();
        worldrenderer.pos(d3, d5, d1).func_181675_d();
        worldrenderer.pos(d3, d4, d1).func_181675_d();
        worldrenderer.pos(d2, d4, d0).func_181675_d();
        worldrenderer.pos(d2, d5, d0).func_181675_d();
        worldrenderer.pos(d2, d5, d0).func_181675_d();
        worldrenderer.pos(d2, d4, d0).func_181675_d();
        worldrenderer.pos(d1, d4, d0).func_181675_d();
        worldrenderer.pos(d1, d5, d0).func_181675_d();
        worldrenderer.pos(d1, d5, d0).func_181675_d();
        worldrenderer.pos(d1, d4, d0).func_181675_d();
        worldrenderer.pos(d0, d4, d1).func_181675_d();
        worldrenderer.pos(d0, d5, d1).func_181675_d();
        worldrenderer.pos(d0, d5, d1).func_181675_d();
        worldrenderer.pos(d0, d4, d1).func_181675_d();
        worldrenderer.pos(d0, d4, d2).func_181675_d();
        worldrenderer.pos(d0, d5, d2).func_181675_d();
        worldrenderer.pos(d0, d5, d2).func_181675_d();
        worldrenderer.pos(d0, d4, d2).func_181675_d();
        worldrenderer.pos(d1, d4, d3).func_181675_d();
        worldrenderer.pos(d1, d5, d3).func_181675_d();
        worldrenderer.pos(d1, d5, d3).func_181675_d();
        worldrenderer.pos(d1, d4, d3).func_181675_d();
        worldrenderer.pos(d2, d4, d3).func_181675_d();
        worldrenderer.pos(d2, d5, d3).func_181675_d();
