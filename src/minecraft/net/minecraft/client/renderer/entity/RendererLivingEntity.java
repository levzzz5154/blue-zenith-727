...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T> {
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        try {
            ...
            Rotations rot = (Rotations) BlueZenith.moduleManager.getModule(Rotations.class);
            boolean s = rot.getState() && entity == Minecraft.getMinecraft().thePlayer;
            if (s) {
                f = interpolateRotation(rot.prevYaw, rot.yaw, partialTicks);
                f1 = interpolateRotation(rot.prevYaw, rot.yaw, partialTicks);
                entityYaw = interpolateRotation(rot.prevYaw, rot.yaw, partialTicks);
                f7 = rot.pitch;
            }
            float f2 = f1 - f;
