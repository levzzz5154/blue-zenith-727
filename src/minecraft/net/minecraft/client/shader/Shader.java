...
public class Shader
{
    ...
    public void loadShader(float p_148042_1_)
    {
        ...
        worldrenderer.pos(0.0D, (double)f1, 500.0D).color(255, 255, 255, 255).func_181675_d();
        worldrenderer.pos((double)f, (double)f1, 500.0D).color(255, 255, 255, 255).func_181675_d();
        worldrenderer.pos((double)f, 0.0D, 500.0D).color(255, 255, 255, 255).func_181675_d();
