...
public class AntiBan extends Module {
    private final BoolValue confirm = new BoolValue("confirm", "C0FPacketConfirmTransaction", true, true, null);
    private final BoolValue keepalive = new BoolValue("keepalive", "C00PacketKeepAlive", false, true, null);
