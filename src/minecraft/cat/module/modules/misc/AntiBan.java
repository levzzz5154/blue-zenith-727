...
public class AntiBan extends Module {
    private final BoolValue confirm = new BoolValue("confirm", "ConfirmTransaction", false, true, null);
    private final BoolValue keepalive = new BoolValue("keepalive", "KeepAlive", false, true, null);
