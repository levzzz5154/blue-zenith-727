...
public class MinecraftFontRenderer extends CFont {
    ...
    public int drawStringWithShadow(String text, float x, float y, int color) {
        float shadowWidth = this.drawString(text, x + 0.5, y + 0.5, color, true, 8.3f);
        return (int)Math.max(shadowWidth, this.drawString(text, x, y, color, false, 8.3f));
    }
    ...
    @Override
    public int drawString(String t, float x, float y, int color, boolean shadow){
        if(shadow){
            float s = this.drawString(t, x + 0.5f, y + 0.5f, color, true, 8.3f);
            return (int) Math.max(s, this.drawString(t, x, y, color, false, 8.3f));
        }else{
            return (int) this.drawString(t, x, y, color, false, 8.3f);
        }
    }
    ...
    public int getStringWidth(String text) {
        ...
        return (int) (width / (2 * fontScaleOffset));
    }
