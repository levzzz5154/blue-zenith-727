...
public class RenderSystem {
    ...
    public static void tracerLine(Entity entity, int mode) {
        RenderManager skidIssue = Minecraft.getMinecraft().getRenderManager();
        double x2 = entity.posX - skidIssue.renderPosX;
        double y2 = entity.posY + entity.height / 2.0F - skidIssue.renderPosY;
        double z2 = entity.posZ - skidIssue.renderPosZ;
        GL11.glBlendFunc(770, 771);
        GL11.glEnable(3042);
        ...
        if (mode == 0) {
            ...
            Minecraft.getMinecraft();
            Minecraft.getMinecraft();
            GL11.glColor4d(1.0F - Minecraft.getMinecraft().thePlayer.getDistanceToEntity(entity) / 40.0F, Minecraft.getMinecraft().thePlayer.getDistanceToEntity(entity) / 40.0F, 0.0D, 0.5D);
        } else if (mode == 1) {
    ...
    public static void tracerLine(int x2, int y2, int z2, Color color) {
        RenderManager skidIssue = Minecraft.getMinecraft().getRenderManager();
        x2 = (int) (x2 + (0.5D - skidIssue.renderPosX));
        y2 = (int) (y2 + (0.5D - skidIssue.renderPosY));
        z2 = (int) (z2 + (0.5D - skidIssue.renderPosZ));
        GL11.glBlendFunc(770, 771);
        GL11.glEnable(3042);
        GL11.glLineWidth(2.0F);
        GL11.glDisable(3553);
